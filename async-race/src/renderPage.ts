...
const renderCar = (auto: Auto) => `
        <div class='auto-item__controls'>
           <button class='select__auto button-project' id='select-auto-${auto.id}'>SELECT</button>
          <button class='delete__auto button-project' id='remove-auto-${auto.id}'>REMOVE</button>
        ...
        <div class='auto-item__race'>
          ...
          <div class='auto__ico' id='auto-${auto.id}'>
            <svg class='auto__ico-it' fill="${auto.color}" width="80px" height="80px" viewBox="0 -39.69 122.88 122.88" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 style="enable-background:new 0 0 122.88 43.49" xml:space="preserve" stroke="${auto.color}" transform="matrix(-1, 0, 0, 1, 0, 0)">
          ...
          <div class="flag__ico" id='flag-ico-${auto.id}'>
...
const renderGarage = () => `
  <h1 class="h1">Garage (4)</h1>
    <div class="pagination-garage pagination">
      <span>Page</span>
      <span class="pagination__garage-page">#1</span>
    </div>
...
export const renderPage = async () => {
  ...
  <div class='garage-view'>
    ...
    <div class='create-auto change-auto'>
    ...
    <div class='update-auto change-auto'>
  ...
  <div class="winners-view">
    ...
    <h1 class="h1">Winners (3)</h1>
    <div class="pagination-winners pagination">
      <span>Page</span>
      <span class="pagination__winners-page">#1</span>
    </div>
    ...
    <table class="winners__table">
      ...
      <tr>
        <td>1</td>
        <td>
          <svg class="auto__ico-it" fill="#dc0909" width="25px" height="25px" viewBox="0 -39.69 122.88 122.88"
               version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
               style="enable-background:new 0 0 122.88 43.49" xml:space="preserve" stroke="#dc0909"
